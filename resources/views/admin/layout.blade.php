...
<head>
    ...
    <link href="{{env('APP_URL')}}/back/vendor/fontawesome-free/css/all.min.css" rel="stylesheet" type="text/css">
...
<!-- Page Wrapper -->
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                <a class="nav-link" href="{{route('competitor.index')}}">
...
<!-- End of Page Wrapper -->
    ...
    <script src="{{env('APP_URL')}}/back/vendor/jquery/jquery.min.js"></script>
    <script src="{{env('APP_URL')}}/back/vendor/bootstrap/js/bootstrap.bundle.min.js"></script>

    <!-- Core plugin JavaScript-->
    <script src="{{env('APP_URL')}}/back/vendor/jquery-easing/jquery.easing.min.js"></script>

    <!-- Custom scripts for all pages-->
    <script src="{{env('APP_URL')}}/back/js/sb-admin-2.min.js"></script>

    <!-- Page level plugins -->
    <script src="{{env('APP_URL')}}/back/vendor/chart.js/Chart.min.js"></script>
